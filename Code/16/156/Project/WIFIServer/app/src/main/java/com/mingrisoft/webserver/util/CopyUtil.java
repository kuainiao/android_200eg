package com.mingrisoft.webserver.util;
...
public class CopyUtil {
	...
	public boolean assetsCopy() {
		try {
			assetsCopy("wfs", Environment.getExternalStorageDirectory()+ File.separator +"OSSHUHAI"+File.separator+"WIFI"+"/.wfs"); // assets内.wfs文件找不到==
		} catch (IOException e) {
			e.printStackTrace();
			return false;
		}
