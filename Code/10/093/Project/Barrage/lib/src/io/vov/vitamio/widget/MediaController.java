...
public abstract class MediaController extends FrameLayout {
  ...
  protected boolean overrideFileName;
  ...
  public MediaController(Context context,boolean override) {
    super(context);
    mFromXml = true;
    overrideFileName = override == true? true :true;
    initController(context);
  }
  ...
  protected abstract void hideAddView();
