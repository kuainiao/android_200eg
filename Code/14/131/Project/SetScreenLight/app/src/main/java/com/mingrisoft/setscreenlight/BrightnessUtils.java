...
public class BrightnessUtils {
    ...
    public static boolean IsAutoBrightness(Context context) {
        ...
        try {
            IsAutoBrightness = Settings.System.getInt(
                    context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS_MODE) == Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC;
        }
    ...
    public static void setCurWindowBrightness(Context context, int brightness) {
        ...
        lp.screenBrightness = Float.valueOf(brightness) * (1f / 255f);  //设置屏幕的亮度
        activity.getWindow().setAttributes(lp);    //屏幕亮度生效
    }
    /**设置系统亮度
      *程序退出之后亮度依旧有效
     **/
