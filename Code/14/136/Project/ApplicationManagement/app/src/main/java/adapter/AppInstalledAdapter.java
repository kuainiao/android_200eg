...
import com.mingrisoft.applicationmanagement.MainActivity;
import com.mingrisoft.applicationmanagement.R;
...
public class AppInstalledAdapter extends BaseAdapter {
    ...
    private AppInfo appPackageInfo;
    private List<AppInfo> appPackageInfos=null;
    InstalledInterface appInstalledInterface;
    ...
    //设置数据集
    public void setList(List<AppInfo> appPackageInfos){
        this.appPackageInfos=appPackageInfos;
    }

    //设置接口
    public void setAppInstalledInterface(MainActivity appInstalledInterface){
