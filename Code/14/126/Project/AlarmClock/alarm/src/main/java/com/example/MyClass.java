...
public class MyClass {
    public static void main(String[] args) {
        ...
        Schema schema = new Schema(1000, "com.mingrisoft.alarmclock.greendao");
        // 添加需要创建的实体类信息
        addNote(schema);
        try {
    ...
    private static void addNote(Schema schema) {
        ...
        Entity entity = schema.addEntity("TimeEntity");
        // 指定自增长主键
        ...
        entity.addIntProperty("min");
        entity.addBooleanProperty("tf");
    }
}
