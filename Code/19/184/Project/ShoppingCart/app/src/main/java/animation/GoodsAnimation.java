...
public abstract class GoodsAnimation {
    ...
    public static void setAnim(Activity activity , View imgphoto , View imgcar){
        ...
        ImageView buyImg = new ImageView(lActivity);
        // 设置buyImg的图片
        buyImg.setImageResource(R.drawable.ball);
        // 开始执行动画
    ...
    private static void startAnim(final View v, int[] start_location) {
        ...
        int width = getWindowsWidth(lActivity);
        // 计算位移
    ...
    private static ViewGroup createAnimLayout() {
        ViewGroup rootView = (ViewGroup)lActivity.getWindow().getDecorView();
        LinearLayout animLayout = new LinearLayout(lActivity);
