...
public class GestureBuilderActivity extends ListActivity {
    ...
    public void addGesture(View v) {
        Intent intent = new Intent(this, CreateGestureActivity.class);  //跳转到添加手势界面
        startActivityForResult(intent, REQUEST_NEW_GESTURE);  //开始跳转
    }

    /**界面跳转到手势识别界面*/
    public void gesturePerform(View v) {
        Intent intent = new Intent(this, GesturePerformedActivity.class);  //跳转到手势识别界面
    ...
    private class GesturesLoadTask extends AsyncTask<Void, NamedGesture, Integer> {
        ...
        protected void onPreExecute() {
            ...
            mPathColor = resources.getColor(R.color.black);   //设置手势的颜色
