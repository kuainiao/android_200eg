...
public class ScrollingDigitalAnimation extends TextView {
    ...
    public ScrollingDigitalAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ScrollingDigitalAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
